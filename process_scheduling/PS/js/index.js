...
function displayList() {
    ...
    for (var i = 0; i < p.length; i++) {
        ...
        pid.setAttribute("style", "float:left;margin-left:20px; font-family:'Courier New'");
        //card.setAttribute("style", "float:left;");
        card.setAttribute("style", "width:800px;height: 50px; font-family:'Courier New'");
        ...
        btn.setAttribute("style", "float:right;margin-right:50px; color:white; background-color:red");
...
function drawChart() {
    ...
    for (var i = 0; i < gantt.length; i++) {
        var divWidth = (gantt[i].end - gantt[i].start) * 20;
